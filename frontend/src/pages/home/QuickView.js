...
function QucikView(props) {
  ...
  function getProduct(id) {
    setloading(true);
    axios.get(`${ip}/products/${id}`).then((response) => {
      setProductId(id);
          ...
          {loading ? (
            ...
            product && (
              <React.Fragment>
                  ...
                  <div id="product-detail-container" className="col-md-6">
                    ...
                    <div className="product-details">
                        ...
                        <div className="qty-label">
                          ...
                          <div className="input-number">
                            <input
                              ...
                              value={avaibleQuantity ? quantity : 0}
                              onChange={handleChange}
                            />
                      ...
                      <ul className="product-btns">
                        <li>
                          <a id={product.id} onClick={handleWishlist} href="#">
                            <i
                              id={product.id}
                ...
                <Link to={`/detailProduct/${props.productId}`}>
                  <Button bsPrefix="qv">
                    <span>View More</span>
                  </Button>
                </Link>
