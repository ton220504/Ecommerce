...
class Wishlist extends Component {
  ...
  getWishlist(pageNumber) {
    ...
    axios
      .get(`${ip}/product/wishlist?page=${pageNumber}`, {
                  ...
                  {localStorage.getItem("token") ? (
                        ...
                        <tr key={item.id}>
                          <td>
                            <img
                              height="100"
                              width="100"
                              src={`./img/${JSON.parse(item.product.photo)[0]}`}
                              alt={JSON.parse(item.product.photo)[0]}
                            />
                          </td>
                          <td>
                    ...
                    <tr>
                      <td colSpan="6" className="py-5">
                        <h3>
                          Please login to be able to add or view products in
                          your wishlist!
                        </h3>
                      </td>
                    </tr>
